...
// The authored GRAPH GUIDE for Ghana English (phase 2c) — markdown the LLM reads
// to interpret the graph. See docs/design-notes/authorable-catalog.md.
export const GHANA_ENGLISH_GUIDE = `# Ghana English (Basic 1–3) — graph guide

How the Ghana English knowledge graph is shaped. This is a **standards-only
reference framework** — the NaCCA Basic School Curriculum for English Language
...
\`\`\`
Grade (Basic 1 / Basic 2 / Basic 3)
  └─ Strand              (a broad language domain, e.g. Oral Language)
